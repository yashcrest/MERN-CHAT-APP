...
const NavBar = () => {
  ...
  return (
    <>
      <nav className="bg-gray-300 border-grey-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
          ...
          <div
            ...
            id="navbar-default"
          >
            <ul className="font-medium flex flex-col p-4 bg-white md:bg-gray-300 md:p-0 mt-4 border rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-70">
              {userInfo ? (
                <>
                  <li>
